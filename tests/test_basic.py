...
from webscraper.utils import is_same_domain, get_file_extension, is_valid_url
...
class TestRobotsChecker:
    ...
    def test_get_robots_url(self):
        ...
        config = {"general": {"user_agent": "TestBot", "timeout": 30}, "llm": {"api_key": ""}}
...
class TestFileExtractor:
    ...
    def test_extract_from_text_encoding(self):
...
class TestWebScraper:
    ...
    def test_scrape_url_request_failure(self, mock_request):
...
class TestIntegration:
    ...
    def test_end_to_end_scraping(self, mock_robots_get, mock_session_get):
